    ...
    return (
        <>
            <Link href={`/post/${props.id}`} passHref={true}>
                <a className="border-b border-neutral-800 hover:border-neutral-700 transition-colors duration-100 py-4 w-100 flex flex-col md:flex-row justify-between no-underline cursor-pointer">
